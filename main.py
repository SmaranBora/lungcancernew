...
st.write(
    "Welcome to our Lung Cancer Prediction tool. Our goal is to assist you in assessing the likelihood of having lung cancer based on a set of input factors."
)
st.write(
    "By providing information about your gender, age, and various symptoms or lifestyle factors, we can offer insights into your potential risk."
)
st.write(
    "Please answer the questions below to the best of your knowledge, and our tool will provide you with a prediction regarding the presence of lung cancer."
)
st.write(
    " Keep in mind that this tool is for informational purposes only and should not replace professional medical advice."
)
